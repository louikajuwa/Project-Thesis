<?php
	...
	if(isset($submit)) {
		...
		if($num === '' && $time === '' && $duration === '' && $date === '' && $room === '' && $merid === '') 
		{
			...
			@$_SESSION['price_1'] = '390';
			@$_SESSION['price_2'] = '460';
			@$_SESSION['sta_sub'] = $submit;
			header('location: confirm.php');
		}
	}
?>
...
<html>
	<head>
		<title> Crest Hotel | Standard Room </title>
	...
	<body class="body-color">
		...
		<div class="content-fill-form">
			<center><h1 class="header">Standard Room Reservation</h1><hr width="100px">
			<form action="" method="POST">
				...
				<a href="../rooms" class="submit-1">Back</a>
			</form>
			</center>
		</div>	
